...
impl std::fmt::Display for FrontendError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            FrontendError::InvalidNumber(n) => write!(f, "invalid number '{}'", n),
            FrontendError::InvalidRune(r) => write!(f, "invalid rune '{}'", r),
            FrontendError::InvalidOperator => write!(f, "invalid operator"),
            FrontendError::InvalidMetadata(m) => write!(f, "unknown metadata '{}'", m),
            FrontendError::AutoImmutable => write!(f, "auto variables cannot be immutable"),
            FrontendError::ImutDynamic => write!(f, "dynamic variables cannot be immutable"),
